...
{
    [TestFixture]
    public class DyanmicCategoryBasedonLocation : BaseClass
    {
        [Test]
        public void DynamicCategoryBasedonLocation1()
        // check product Availability by Location 
        {
            ...
            driver.FindElement(By.XPath("//div[@class='Ji2MFX']")).Click();
            Thread.Sleep(6000);
            string s3 = driver.FindElement(By.XPath("//div[@class='PEuQti']")).Text;
